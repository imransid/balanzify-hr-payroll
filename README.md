...
docker exec 97755f71c1a8 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 97755f71c1a8 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

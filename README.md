...
docker exec f422fb89d14b npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec f422fb89d14b npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec 224f9a457be3 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 224f9a457be3 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

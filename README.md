...
docker exec 0121fd5f8d09 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 0121fd5f8d09 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec 57727893469d npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 57727893469d npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

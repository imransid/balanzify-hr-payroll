...
docker exec 86e8b0037133 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 86e8b0037133 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

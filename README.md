...
docker exec f7041aa52f74 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec f7041aa52f74 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

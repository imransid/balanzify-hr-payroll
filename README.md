...
docker exec df556df38495 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec df556df38495 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

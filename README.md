...
docker exec ada0f7e03750 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec ada0f7e03750 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

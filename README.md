...
docker exec cab59041fe80 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec cab59041fe80 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec 2fb0e6dbf988 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 2fb0e6dbf988 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec 3c3554112f79 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 3c3554112f79 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec 810a68e01194 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 810a68e01194 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

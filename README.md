...
docker exec bff4af06caf9 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec bff4af06caf9 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

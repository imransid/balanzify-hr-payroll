...
docker exec 997bfb055e61 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 997bfb055e61 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

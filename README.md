...
docker exec 7afbef8ebdb7 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 7afbef8ebdb7 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

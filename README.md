...
docker exec 7598d0965a23 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 7598d0965a23 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec 4afb6b816f0a npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 4afb6b816f0a npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec 90448b09ee86 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 90448b09ee86 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

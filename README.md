...
docker exec 680cc0455d61 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 680cc0455d61 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec fd9edd8318fb npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec fd9edd8318fb npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

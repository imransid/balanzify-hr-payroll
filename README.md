...
docker exec ff32d2bd2611 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec ff32d2bd2611 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

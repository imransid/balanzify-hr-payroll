...
docker exec 14eb96bb62df npx prisma generate --schema=./prisma/schema-hr.prisma
...
docker exec 14eb96bb62df npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

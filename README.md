...
docker exec 1a26ca7fe277 npx prisma generate --schema=./prisma/schema-hr.prisma
...
docker exec 1a26ca7fe277 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

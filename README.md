...
docker exec 63f4c6329229 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 63f4c6329229 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec c547a1011690 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec c547a1011690 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

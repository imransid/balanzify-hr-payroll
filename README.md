...
docker exec db5a51778f77 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec db5a51778f77 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec 2b1ff9e84822 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 2b1ff9e84822 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

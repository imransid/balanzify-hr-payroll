...
docker exec a80996f709a5 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec a80996f709a5 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec 443a6d12776c npx prisma generate --schema=./prisma/schema-hr.prisma
...
docker exec 443a6d12776c npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

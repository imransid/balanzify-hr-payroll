...
docker exec 3860328c9ffd npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 3860328c9ffd npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

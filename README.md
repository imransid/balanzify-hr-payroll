...
docker exec a820ccffe76c npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec a820ccffe76c npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

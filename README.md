...
docker exec 8e32b634b94b npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 8e32b634b94b npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

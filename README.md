...
docker exec 50277440b152 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 50277440b152 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

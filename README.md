# balanzify-hr-payroll - Intelligent Testing Platform
...
docker exec 6dab0eb2d50a npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 6dab0eb2d50a npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

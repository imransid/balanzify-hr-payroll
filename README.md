...
docker exec c9848abcac37 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec c9848abcac37 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

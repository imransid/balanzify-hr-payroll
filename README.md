...
docker exec 18ab7f3e3b94 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 18ab7f3e3b94 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec 5dde6e7c9bf6 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 5dde6e7c9bf6 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

...
docker exec f19e8ab2dae4 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec f19e8ab2dae4 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

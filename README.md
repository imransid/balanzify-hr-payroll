...
docker exec c14d24f48880 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec c14d24f48880 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

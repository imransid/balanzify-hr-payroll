...
docker exec 7ed261a45366 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 7ed261a45366 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

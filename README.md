...
docker exec 98e0a68338b4 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 98e0a68338b4 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

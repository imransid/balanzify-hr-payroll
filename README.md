...
docker exec 655b64c227d3 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 655b64c227d3 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

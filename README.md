...
docker exec a1a6edffbd49 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec a1a6edffbd49 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

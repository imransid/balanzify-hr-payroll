...
docker exec c8d142d8da78 npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec c8d142d8da78 npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma

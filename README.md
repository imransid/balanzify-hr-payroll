...
docker exec 6e40737921fb npx prisma generate --schema=./prisma/schema-hr.prisma
docker exec 6e40737921fb npx prisma db push --force-reset --schema=./prisma/schema-hr.prisma
